...
<nav class="fixed w-full bg-neutral-900 z-10">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 animate__animated animate__fadeIn animate__faster">
        ...
        <div class="flex gap-4 items-center order-3 md:order-3 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <button type="button" class="flex text-sm bg-neutral-900 rounded-full md:me-0 focus:ring-4 focus:ring-neutral-800 cursor-pointer" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        ...
        <div class="items-center justify-between hidden w-full order-3 md:flex md:w-auto md:order-2" id="navbar-user">
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-neutral-700 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-neutral-950 md:bg-neutral-900">
                <li>
                    <a href="/" class="py-2 px-3 rounded-sm md:p-0 text-white md:hover:text-blue-600 hover:bg-neutral-700 md:hover:bg-transparent border-neutral-700 flex gap-2 items-center">
